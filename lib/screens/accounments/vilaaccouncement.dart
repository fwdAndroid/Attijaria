...
class VilaAnnouncement extends StatefulWidget {
  const VilaAnnouncement({Key? key}) : super(key: key);

  @override
  _VilaAnnouncementState createState() => _VilaAnnouncementState();
}

class _VilaAnnouncementState extends State<VilaAnnouncement> {
  @override
