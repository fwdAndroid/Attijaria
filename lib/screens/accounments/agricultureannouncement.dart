...
class AgricultureAnnouncement extends StatefulWidget {
  const AgricultureAnnouncement({Key? key}) : super(key: key);

  @override
  _AgricultureAnnouncementState createState() =>
      _AgricultureAnnouncementState();
}

class _AgricultureAnnouncementState extends State<AgricultureAnnouncement> {
  @override
