...
class PhoneAnnouncement extends StatefulWidget {
  const PhoneAnnouncement({Key? key}) : super(key: key);

  @override
  _PhoneAnnouncementState createState() => _PhoneAnnouncementState();
}

class _PhoneAnnouncementState extends State<PhoneAnnouncement> {
  @override
                ...
                child: Stack(
                  children: [
                    Container(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(20),
                        child: Image.asset('asset/telephone.png',
