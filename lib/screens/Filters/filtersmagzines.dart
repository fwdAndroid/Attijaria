import 'package:attijaria/screens/Filters/filterstreains.dart';
import 'package:flutter/material.dart';
import 'package:hexcolor/hexcolor.dart';

class Magasins extends StatefulWidget {
  const Magasins({Key? key}) : super(key: key);
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                enabledBorder: OutlineInputBorder(
                    borderSide: BorderSide(color: HexColor('#9098B1'))),
                // ignore: prefer_const_constructors
                hintText: ("Magasins , commerces et locaux industiels "),
                focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(5.0),
                    borderSide: BorderSide(
                      color: HexColor('#F8B800'),
