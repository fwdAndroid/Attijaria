import 'package:attijaria/screens/Filters/colocations.dart';
import 'package:flutter/material.dart';
import 'package:hexcolor/hexcolor.dart';

class LocationFit extends StatefulWidget {
  const LocationFit({Key? key}) : super(key: key);

  @override
  _LocationFitState createState() => _LocationFitState();
}

class _LocationFitState extends State<LocationFit> {
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ListTile(
                    contentPadding: EdgeInsets.only(left: 30),
                    title: Text('Capacité (Personnes)'),
                    leading: Image.asset('assets/icons/capacite.png'),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(left: 50, right: 130),
                    child: Row(
              ...
              onTap: () {
                Navigator.push(
                    ...
                    new MaterialPageRoute(
                        builder: (context) => new Colocations()));
              },
              child: Padding(
