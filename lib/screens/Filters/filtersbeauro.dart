import 'package:attijaria/screens/Filters/filtersmagzines.dart';
import 'package:flutter/material.dart';
import 'package:hexcolor/hexcolor.dart';

class FiltersBeauro extends StatefulWidget {
  const FiltersBeauro({Key? key}) : super(key: key);

  @override
  _FiltersBeauroState createState() => _FiltersBeauroState();
}

class _FiltersBeauroState extends State<FiltersBeauro> {
              ...
              Column(
                ...
                children: [
                  ListTile(
                    contentPadding: EdgeInsets.only(left: 30),
                    title: Text('Etage'),
                    leading: Image.asset('assets/icons/etage.png'),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(left: 50, right: 130),
                    child: Row(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ListTile(
                    contentPadding: EdgeInsets.only(left: 30),
                    title: Text('Surface supente (m²)'),
                    leading: Image.asset('assets/icons/surface.png'),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(left: 50, right: 130),
                    child: Row(
