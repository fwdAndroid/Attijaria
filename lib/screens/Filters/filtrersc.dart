...
class FiltrerSc extends StatefulWidget {
  const FiltrerSc({Key? key}) : super(key: key);

  @override
  _FiltrerScState createState() => _FiltrerScState();
}

class _FiltrerScState extends State<FiltrerSc> {
