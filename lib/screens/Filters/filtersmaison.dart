import 'package:attijaria/screens/Filters/filtersbeauro.dart';
import 'package:flutter/material.dart';
import 'package:hexcolor/hexcolor.dart';

class FiltersMaisons extends StatefulWidget {
  const FiltersMaisons({Key? key}) : super(key: key);

  @override
  _FiltersMaisonsState createState() => _FiltersMaisonsState();
}

class _FiltersMaisonsState extends State<FiltersMaisons> {
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ListTile(
                    contentPadding: EdgeInsets.only(left: 30),
                    leading: Image.asset('assets/icons/sofa.png'),
                  ),
                  Padding(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ListTile(
                    contentPadding: EdgeInsets.only(left: 30),
                    leading: Image.asset('assets/icons/network.png'),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(left: 50, right: 130),
                    child: Row(
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (ctx) => FiltersBeauro()));
                },
                child: Padding(
