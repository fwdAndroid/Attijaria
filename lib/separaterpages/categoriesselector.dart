    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
         ...
         if(Provider.of<AllpProviders>(context,listen: false).cetagory!.isEmpty){}else if(Provider.of<AllpProviders>(context,listen: false).cetagory!.isNotEmpty){     Navigator.push(context, MaterialPageRoute(builder: (builder) => SelectSubCategories()));
         }
