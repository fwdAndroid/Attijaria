                                  ...
                                  child: InkWell(
                                      onTap: () {
                                        Provider.of<AllpProviders>(context,
                                                listen: false)
                                            .setSubCetagory(
                                                "Part and accessories for vehicles");
                                        Navigator.pop(context);
                                      },
                                      child: Text(
                                          'Part and accessories for vehicles')),
                                  ...
                                  child: InkWell(
                                      onTap: () {
                                        Provider.of<AllpProviders>(context,
                                                listen: false)
                                            .setSubCetagory(
                                                "Store,bussiness and Industrial premises");
                                        Navigator.pop(context);
                                      },
                                      child: Text(
                                          'Store,bussiness and Industrial premises')),
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                      onTap: () {
                                        Provider.of<AllpProviders>(context,
                                                listen: false)
                                            .setSubCetagory("Lands and Farms");
                                        Navigator.pop(context);
                                      },
                              ...
                              children: [
                                  ...
                                  child: InkWell(
                                      onTap: () {
                                        Provider.of<AllpProviders>(context,
                                                listen: false)
                                            .setSubCetagory(
                                                'Clothing for childern and babies');
                                        Navigator.pop(context);
                                      },
                                      child: Text(
                                          'Clothing for childern and babies')),
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                      onTap: () {
                                        Provider.of<AllpProviders>(context,
                                                listen: false)
                                            .setSubCetagory('Beauty Products');
                                        Navigator.pop(context);
                                      },
                                  ...
                                  child: InkWell(
                                      onTap: () {
                                        Provider.of<AllpProviders>(context,
                                                listen: false)
                                            .setSubCetagory(
                                                'House Keepers,Nany Drivers');
                                        Navigator.pop(context);
                                      },
                                      child:
                                          Text('House Keepers,Nany Drivers')),
                                ),
                                Padding(
                                  padding:
                                      const EdgeInsets.symmetric(vertical: 10),
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                      onTap: () {
                                        Provider.of<AllpProviders>(context,
                                                listen: false)
                                            .setSubCetagory('Job Applications');
                                        Navigator.pop(context);
                                      },
                                  ...
                                  child: InkWell(
                                      onTap: () {
                                        Provider.of<AllpProviders>(context,
                                                listen: false)
                                            .setSubCetagory(
                                                'Bussiness and commercials affairs');
                                        Navigator.pop(context);
                                      },
                                      child: Text(
                                          'Bussiness and commercials affairs')),
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                      ...
                                      child:
                                          const Text(' Stock and wholesales')),
                                ),
                              ],
                            )
                          ],
